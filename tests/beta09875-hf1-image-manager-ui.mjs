...
try{
  ...
  const pkg=JSON.parse(readFileSync(path.join(root,'package.json'),'utf8'));assert.ok(['0.9875.2','0.99.0','0.99.1','0.99.2','0.99.3','0.99.4','0.99.5','0.99.6','0.99.6-1','0.99.6-2','0.991.0','0.991.1'].includes(pkg.version));assert.equal(pkg.scripts['test:hf1'],'node tests/beta09875-hf1-image-manager-ui.mjs');
