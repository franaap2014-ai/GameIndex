...
export const INTERNAL_RELEASE="0.991-I1";
export const INTERNAL_RELEASE_LABEL="GameIndex Beta 0.991 I1";
export const INTERNAL_RELEASE_CODE="BETA_0_991_I1_RELIABILITY_NAVIGATION_DIAGNOSTICS";
export const TARGET_SCHEMA=42;
