const GV={
  ...
  async transitionTheme(nextState={},options={}){
    ...
    const overlay=document.createElement("div");overlay.className="gi-theme-power-transition";overlay.setAttribute("role","presentation");overlay.style.setProperty("--gi-old-accent",oldAccent);overlay.style.setProperty("--gi-new-accent",oldAccent);
