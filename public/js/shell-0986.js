(()=>{
  if(!document.querySelector('link[data-gi09915-polish]')){
    const link=document.createElement("link");link.rel="stylesheet";link.href="/css/gameindex-09915.css?v=09915hf2";link.dataset.gi09915Polish="1";document.head.appendChild(link);
  }
})();
const GV={
...
(()=>{
  ...
  script.src="/js/gameindex-0991-i1.js?v=09915";
  script.defer=true;
